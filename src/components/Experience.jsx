...
const TIMELINE = [
  {
    ...
    period: "Apr 2025 - May 2025", location: "Bengaluru, India",
    points: [
      "Cleaned and validated 10,000+ operational customer datasets using Excel and Python, performing multi-source data reconciliation to achieve 100% data integrity for internal audits.",
      "Engineered automated weekly MIS reporting workflows using Power Query and Power BI, saving 8+ manual operational hours weekly and accelerating management decision cycles by 35%.",
      "Collaborated with cross-functional teams to track key performance indicators (KPIs) and optimized operational reporting routines across 3 major internal channels.",
      "Designed interactive KPI tracking dashboards in Power BI, giving senior leadership real-time visibility into operational bottlenecks and service SLA compliance.",
    ],
  ...
  },
  {
    ...
    period: "Jul 2024 - Apr 2027", location: "Bengaluru, India",
    points: [
